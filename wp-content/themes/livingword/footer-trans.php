    ...
    <footer>
        ...
        <div id="footer">
            <div id="get-in-touch-section" class="wrapper">
                <h3 class="title"><?php echo get_field('footer_title', 'options'); ?></h3>
                <div class="title-line"></div>
                <div style="font-family:'ChronicleTextG1-Roman';font-size:21px;line-height:27px;"><a href="<?php echo get_permalink(get_page_by_path('contact')); ?>">Get in touch!</a></div>
            </div>

            <div class="wrapper">
                <div class="col copy  fade " data-animation='{"animation": "slide", "delay": 0.75, "group": 99}'>
                ...
                <div class="clearfix">
                    <div id="copyright">©<?php echo date('Y'); ?> The Living Word Language Services Ltd</div>
                    <div id="rights">Designed by 3rd Ear</div>
                </div>
            </div>
        </div>
    </footer>
