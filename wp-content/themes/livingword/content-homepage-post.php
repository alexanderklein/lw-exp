<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <a class="post-item<?php echo ($has_thumbnail && $post_index == 0) ? ' has-thumbnail' : ''; ?><?php echo ($post_index > 0) ? ' small' : ''; ?> scroll-anim fade slide-anim" href="<?php the_permalink(); ?>" data-animation='{"animation": "slide", "delay": <?php echo 1 + $post_index * 0.15; ?>, "group": 4}'>
